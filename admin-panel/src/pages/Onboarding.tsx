...
const Onboarding = () => {
  ...
  const [welcomeMessage, setWelcomeMessage] = useState(
    t('onboarding.triggers.help', 'Biraz yardım sunun 👋')
  );
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.error(errorMessage(error, t('onboarding.setupError', 'Bir hata oluştu.')));
    } finally {
      setLoading(false);
    }
  };
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    <select className="w-24 px-3 py-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-green-500">
                      <option>🇹🇷 +90</option>
                      <option>🇺🇸 +1</option>
                    </select>
                    <input
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-sm">
                      {title || t('onboarding.previewName', 'Destek Ekibi')}
                    </div>
                    <div className="text-xs text-blue-100">
                      {t('onboarding.previewRole', 'Müşteri Temsilcisi')}
                    </div>
                  </div>
                </div>
              </div>
              <div className="p-4 bg-white dark:bg-gray-800 h-full flex flex-col">
                <div className="text-center text-xs text-gray-400 mb-4 whitespace-nowrap">
                  {t('onboarding.previewAgency', 'Canlı Destek Sağlayıcısı Support.io')}
                </div>
        ...
        return (
          <div className="animate-fade-in-up flex flex-col md:flex-row gap-8">
            ...
            <div className="hidden md:block w-72 bg-gray-100 dark:bg-gray-800 rounded-3xl overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-700 h-[450px] relative">
              ...
              <div className="p-4 bg-white dark:bg-gray-800 h-full flex flex-col">
                <div className="flex gap-2 mb-4 mt-auto">
                  <div className="w-8 h-8 rounded-full bg-indigo-100 flex-shrink-0 flex items-center justify-center text-xs">
                    {title?.charAt(0) || 'U'}
                  </div>
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  <span className="px-3 py-1.5 border border-blue-400 text-blue-500 rounded-full text-xs">
                    {t('onboarding.chatBtn1', 'Merhaba!')}
                  </span>
                  <span className="px-3 py-1.5 border border-blue-400 text-blue-500 rounded-full text-xs">
                    {t('onboarding.chatBtn2', 'Yardıma ihtiyacım var')}
                  </span>
                </div>
              </div>
            </div>
      ...
      case 4:
        return (
          <div className="animate-fade-in-up flex flex-col md:flex-row gap-8">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {t(
                      'onboarding.nameDesc',
                      'Müşterilerle sohbet ettiğinizde adınız ve ünvanınız görüntülenecek'
                    )}
                  </p>
                </div>
                <div>
                    ...
                    {colors.map((c) => (
                      <button
                        ...
                        className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${
                          color === c.value
                            ? 'ring-4 ring-offset-2 ring-green-500 dark:ring-offset-gray-900'
                            : ''
                        }`}
            ...
            <div className="hidden md:block w-72 bg-gray-100 dark:bg-gray-800 rounded-3xl overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-700 h-[450px] relative">
              <div
                className="h-20 p-4 flex items-center justify-between text-white rounded-t-3xl transition-colors duration-300"
          ...
          <div className="bg-gray-50 dark:bg-gray-800/50 p-6 md:px-12 border-t border-gray-100 dark:border-gray-700 flex flex-col items-center relative">
            ...
            <div className="w-full flex justify-between items-center absolute inset-y-0 px-6 md:px-12">
              ...
              {step < 4 ? (
                ...
                >
                  {loading
                    ? t('onboarding.completing', 'Tamamlanıyor...')
                    : t('onboarding.complete', 'Tamamla')}{' '}
