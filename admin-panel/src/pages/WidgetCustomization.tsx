...
const toDraft = (config: WidgetConfig): WidgetConfig => JSON.parse(JSON.stringify(config));
...
const WidgetCustomization = () => {
  ...
  const deriveFromPrimary = () => {
    ...
    const isDark = matchPreset(draft.colors)
      ...
      : false;
    patch('colors', derivePalette(primary, { dark: isDark }) as unknown as Record<string, unknown>);
  ...
  const uploadLogo = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      setSaved((s) => (s ? { ...s, branding: { ...s.branding, logo: next.branding.logo } } : s));
  ...
  const removeLogo = async () => {
    ...
    try {
      ...
      setSaved((s) => (s ? { ...s, branding: { ...s.branding, logo: null } } : s));
                  ...
                  >
                    <div className="divide-y divide-gray-100 dark:divide-gray-800">
                      <ColorField
                        ...
                        onChange={(v: any) => patch('colors', { primary: v })}
                      ...
                      <ColorField
                        ...
                        onChange={(v: any) => patch('colors', { header: v })}
                      />
                      <ColorField
                        label={t('studio.colors.background')}
                        value={draft.colors.background}
                        onChange={(v: any) => patch('colors', { background: v })}
                      />
                      <ColorField
                        label={t('studio.colors.text')}
                        value={draft.colors.text}
                        onChange={(v: any) => patch('colors', { text: v })}
                        contrastAgainst={draft.colors.background}
                        contrastLabel={t('studio.contrast')}
                      />
                      <ColorField
                        ...
                        onChange={(v: any) => patch('colors', { textSecondary: v })}
                        contrastAgainst={draft.colors.background}
                        contrastLabel={t('studio.contrast')}
                      />
                      <ColorField
                ...
                <>
                  ...
                  <Section title={t('studio.brand.identity')}>
                    ...
                    <Toggle
                      ...
                      onChange={(v: any) => patch('branding', { showBrandName: v })}
                    />
                    {draft.branding.logo && (
                ...
                <>
                  ...
                  <Section title={t('studio.launcher.size')}>
                    <SizePicker
                      ...
                      onChange={(v: any) => patch('button', { size: v })}
                      color={draft.colors.primary}
                      labels={sizeLabels}
                    />
                  </Section>
                  ...
                  <Section title={t('studio.launcher.icon')}>
                    <IconPicker
                      ...
                      onChange={(v: any) => patch('button', { icon: v })}
                      color={draft.colors.primary}
                  ...
                  <Section title={t('studio.launcher.shape')}>
                    ...
                    <Toggle
                      ...
                      onChange={(v: any) => patch('button', { shadow: v })}
                    />
                    <Toggle
                      id="btn-label"
                      ...
                      onChange={(v: any) => patch('button', { showLabel: v })}
                    />
                ...
                <>
                  ...
                  <Section title={t('studio.messages.bubbles')}>
                    ...
                    <Toggle
                      ...
                      onChange={(v: any) => patch('messages', { showTimestamps: v })}
                    />
                    <Toggle
                      id="avatars"
                      label={t('studio.messages.senderNames')}
                      checked={draft.messages.showAvatars !== false}
                      onChange={(v: any) => patch('messages', { showAvatars: v })}
                    />
                  </Section>
                  ...
                  >
                    <Toggle
                      ...
                      onChange={(v: any) => patch('behavior', { autoOpen: v })}
                    />
                    ...
                    <Toggle
                      ...
                      onChange={(v: any) => patch('behavior', { showUnreadBadge: v })}
                    />
                    <Toggle
                      id="sound"
                ...
                <>
                  ...
                  >
                    ...
                    <Toggle
                      ...
                      onChange={(v: any) => patch('window', { showHeader: v })}
                    />
                    <Toggle
                      id="show-close"
                      label={t('studio.advanced.showClose')}
                      checked={draft.window.showCloseButton !== false}
                      onChange={(v: any) => patch('window', { showCloseButton: v })}
                    />
                  </Section>
                  ...
                  <Section title={t('studio.advanced.motion')}>
                    <Segmented
                      ...
                      onChange={(v: any) => patch('advanced', { animationSpeed: v })}
                      options={[
