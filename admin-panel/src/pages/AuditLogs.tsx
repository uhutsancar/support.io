...
const ACTIONS = [
  ...
  'AUTOMATION_RULE_CREATED', 'AUTOMATION_RULE_UPDATED', 'AUTOMATION_RULE_DELETED', 'AUTOMATION_EXECUTED'
];
          ...
          <form className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-4 items-end" onSubmit={handleSearch}>
              ...
              <div className="relative">
                ...
                >
                  ...
                  {ACTIONS.filter(a => a).map(a => (
                    <option key={a} value={a}>{label('audit.actions.' + a, a)}</option>
                  ))}
                </select>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                onClick={() => { setFilters({ action: '', start: '', end: '' }); setPage(1); fetchLogs({ page: 1 }); }}
              >
                    ...
                    <tr key={d._id} className="hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition-colors group">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 hidden sm:table-cell">
                        <div className="flex flex-col">
                          <span className="font-medium">{d.entityType ? label(`audit.entities.${d.entityType}`, d.entityType) : '-'}</span>
