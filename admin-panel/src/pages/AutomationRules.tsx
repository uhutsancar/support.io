...
const AutomationRules = () => {
    ...
    const [confirmDialog, setConfirmDialog] = useState<{ isOpen: boolean; ruleId: string | null; ruleName: string }>({
        isOpen: false,
        ruleId: null,
        ruleName: ''
    });

    /** One rule as the editor holds it while it is being written. */
    interface RuleForm {
        siteId: string;
        name: string;
        isActive: boolean;
        ...
        conditions: Array<{ field: string; operator: string; value: string; [key: string]: string }>;
        /** The payload's keys depend on the action: `text`, `tag`, and so on. */
