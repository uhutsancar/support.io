...
const Assigned = () => {
  ...
  useEffect(() => {
    ...
    const onAssigned = (e: Event) => {
      const payload = (e as CustomEvent).detail || e;
                    ...
                    <td className="px-6 py-4 max-w-[150px] sm:max-w-xs xl:max-w-md">
                      <div className="flex items-center space-x-3 min-w-0">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="text-sm font-medium text-gray-900 dark:text-white truncate">{ticket.ticketId || `#${ticket.ticketNumber}`}</div>
                          <div className="text-xs text-gray-500 dark:text-gray-400 truncate">{ticket.visitorName || t('dashboard.visitor')}</div>
                        </div>
                      </div>
                    </td>
