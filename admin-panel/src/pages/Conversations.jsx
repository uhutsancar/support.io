    ...
    const handleConversationUpdate = (data) => {
      ...
      if (selectedConversation && selectedConversation._id === data.conversationId) {
        ...
        setSelectedConversation(prev => ({
          ...prev,
          ...data.conversation,
          // Preserve populated fields if not included in update
          ...
          <div className="flex-1 overflow-y-auto overflow-x-hidden min-h-0">
            {filteredConversations.length === 0 ? (
              <div className="p-4 sm:p-6 text-center text-gray-500 dark:text-gray-400 transition-colors duration-200">
                ...
                <p className="text-xs sm:text-sm">{conversations.length === 0 ? t('conversations.noConversations') : 'Filtre kriterlerine uygun konuşma bulunamadı'}</p>
              </div>
            ) : (
