  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">DestekChat yönetim panelinize hoş geldiniz</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <h3 className="font-semibold text-gray-900">Yeni Site Ekle</h3>
            <p className="text-sm text-gray-600 mt-1">Yeni bir web sitesine sohbet widget'i ekleyin</p>
          </button>
          <button 
          ...
          >
            ...
            <h3 className="font-semibold text-gray-900">Konuşmaları Görüntüle</h3>
            <p className="text-sm text-gray-600 mt-1">Müşterilerinizle sohbet edin</p>
          </button>
          <button 
          ...
          >
            ...
            <h3 className="font-semibold text-gray-900">SSS Oluştur</h3>
            <p className="text-sm text-gray-600 mt-1">Otomatik yanıtlar ekleyin</p>
          </button>
        </div>
      </div>

      {/* Getting Started */}
      <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl shadow-sm p-8 text-white">
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div>
              ...
              <p className="text-indigo-100 text-sm">Siteler bölümüne giderek web sitenizi ekleyin ve benzersiz bir site anahtarı alın</p>
            </div>
          </button>
          <div className="flex items-start space-x-3 p-3">
            ...
            <div>
              ...
              <p className="text-indigo-100 text-sm">Widget kodunu kopyalayıp web sitenizin HTML koduna yapıştırın</p>
            </div>
          </div>
          <button
            onClick={() => navigate('/dashboard/conversations')}
          ...
          >
            ...
            <div>
              ...
              <p className="text-indigo-100 text-sm">Müşterileriniz artık sohbet widget'ı üzerinden size ulaşabilir</p>
            </div>
          </button>
        </div>
      </div>
