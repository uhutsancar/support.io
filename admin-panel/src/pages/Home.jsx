    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/register"
                className="bg-white text-indigo-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-indigo-50 transition flex items-center justify-center"
              >
                Ücretsiz Başlayın
              ...
              <Link
                to="/ozellikler"
                className="bg-indigo-600 bg-opacity-30 backdrop-blur-sm text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-opacity-40 transition border-2 border-white border-opacity-30"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl p-8 text-white">
              ...
              <Link
                to="/register"
                className="block w-full bg-white text-indigo-600 py-3 rounded-lg font-semibold text-center hover:bg-indigo-50 transition"
              >
                Şimdi Deneyin
              </Link>
            </div>
      ...
      <section className="bg-gray-900 text-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            to="/register"
            className="inline-flex items-center bg-indigo-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-indigo-700 transition"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-lg font-bold text-gray-900">DestekChat</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link to="/ozellikler" className="text-gray-600 hover:text-gray-900">Özellikler</Link></li>
                <li><Link to="/fiyatlandirma" className="text-gray-600 hover:text-gray-900">Fiyatlandırma</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link to="/hakkimizda" className="text-gray-600 hover:text-gray-900">Hakkımızda</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link to="/login" className="text-gray-600 hover:text-gray-900">Giriş Yap</Link></li>
                <li><Link to="/register" className="text-gray-600 hover:text-gray-900">Kayıt Ol</Link></li>
              </ul>
            </div>
          </div>
