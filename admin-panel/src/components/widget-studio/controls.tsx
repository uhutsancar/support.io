...
export const Toggle = ({
  ...
  <div className="flex items-start justify-between gap-4 py-1">
    <div className="min-w-0">
      <label
        htmlFor={id}
        className="block text-[13px] font-medium text-gray-700 dark:text-gray-300 cursor-pointer"
      >
        {label}
      </label>
      {description && (
...
export const ColorField = ({
  ...
  value: string;
  onChange: (value: string) => void;
  /** The colour the contrast ratio is measured against. */
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-1.5">
      <div className="min-w-0 flex-1">
        <span className="block text-[13px] font-medium text-gray-700 dark:text-gray-300 truncate">
          {label}
        </span>
        {verdict && (
          <span
...
export const PositionPicker = ({
  ...
  value: string;
  onChange: (value: string) => void;
  /** The widget's primary colour, used for the preview dot. */
  color: string;
      ...
      >
        ...
        >
          <span
            ...
            style={{ backgroundColor: readableOn(c.header), opacity: 0.9 }}
          />
          <span
            className="h-1 w-8 rounded-full"
            style={{ backgroundColor: readableOn(c.header), opacity: 0.55 }}
          />
        </div>
...
export const LAUNCHER_ICONS = {
  ...
  'life-buoy':
    'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM4.93 4.93l4.24 4.24M14.83 14.83l4.24 4.24M14.83 9.17l4.24-4.24M9.17 14.83l-4.24 4.24',
  headphones:
...
export const IconPicker = ({
  ...
  value: string;
  onChange: (value: string) => void;
  /** The widget's primary colour, used for the selected state. */
  color: string;
  label?: string;
}) => (
