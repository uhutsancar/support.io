...
const StudioPreview = ({ config, open, device = 'desktop', availability = 'online', strings }: { config?: any; open?: boolean; strings?: any; [prop: string]: any }) => {
  ...
  const iconPath = LAUNCHER_ICONS[button.icon as keyof typeof LAUNCHER_ICONS] || LAUNCHER_ICONS['message-circle' as keyof typeof LAUNCHER_ICONS];
