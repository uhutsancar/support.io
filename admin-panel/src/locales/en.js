export default {
  ...
  sidebar: {
    ...
    settings: 'Settings',
    logout: 'Log Out',
    proactiveRules: 'Proactive Rules',
  ...
  automation: {
    ...
    fetchError: 'Failed to load automation rules',
    fetchSiteError: 'Failed to load rules for the selected site',
    ...
    statusUpdateSuccess: 'Rule status updated',
    statusUpdateError: 'Error updating rule status'
  },
  proactive: {
    ...
    saveRule: 'Save Rule',
    deleteMessage: 'Are you sure you want to delete the "{name}" rule? This action cannot be undone.',
    fetchError: 'Failed to load proactive rules',
    fetchSiteError: 'Failed to load rules for the selected site',
    updateSuccess: 'Rule updated successfully',
    createSuccess: 'Rule created successfully',
    saveError: 'Error saving rule',
  ...
  widgetCustomization: {
    ...
    messages: {
      title: 'Messages',
      welcomeMessagePlaceholder: 'Leave empty for no initial message',
