export default {
  ...
  visitors: {
    ...
    emptyDesc: 'Visitors currently on your site show up here. Leave this open to watch live traffic.',
  ...
  automation: {
    ...
    deleteMessage: 'Are you sure you want to delete the "{{name}}" rule? This action cannot be undone.'
  },
  proactive: {
    fetchError: 'Could not load the rules',
    fetchSiteError: 'Could not load the site\'s rules',
