...
// Minimal RBAC mapping. You can expand permissions here.
...
const checkPermission = (permission) => {
  return async (req, res, next) => {
    try {
      ...
      // Check plan features when needed (permission names can be mapped to features)
      if (req.organization) {
        ...
        // Example: block export if plan doesn't allow
