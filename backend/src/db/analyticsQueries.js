...
function scope(organizationId, siteId, days) {
  const params = [organizationId, `${days} days`];
...
// Headline tiles.
async function overviewStats(organizationId, siteId, days) {
...
async function dailyBreakdown(organizationId, siteId, days) {
  const { sql, params } = scope(organizationId, siteId, days);
...
async function responseTimeByHour(organizationId, siteId, days) {
  const { sql, params } = scope(organizationId, siteId, days);
...
async function channelDistribution(organizationId, siteId, days) {
  const { sql, params } = scope(organizationId, siteId, days);
...
async function slaCompliance(organizationId, siteId, days) {
  const { sql, params } = scope(organizationId, siteId, days);
...
async function departmentBreakdown(organizationId, siteId, days) {
  const { sql, params } = scope(organizationId, siteId, days);
...
async function agentBreakdown(organizationId, siteId, days) {
  const { sql, params } = scope(organizationId, siteId, days);
...
async function statusAndPriorityBreakdown(organizationId, siteId, days) {
  const { sql, params } = scope(organizationId, siteId, days);
...
async function analyticsOverview(organizationId, { siteId = null, range = '7days' } = {}) {
...
module.exports = { analyticsOverview, RANGES };
