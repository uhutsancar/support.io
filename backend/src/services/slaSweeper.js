...
const { sendSLAWarning, handleSLABreach } = require('./escalation');
...
async function sweepOnce(io, { batchSize = DEFAULT_BATCH } = {}) {
...
function startSlaSweeper(io, { intervalMs = Number(process.env.SLA_SWEEP_INTERVAL_MS) || DEFAULT_INTERVAL_MS } = {}) {
...
module.exports = { startSlaSweeper, stopSlaSweeper, sweepOnce };
